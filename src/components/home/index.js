...
import '../../App.css'
import internalTransferABI from '../../components/utils/internalTransferAbi'
...
const Home = () => {
    ...
    useEffect(() => {
        ...
        if (wallet?.provider) {
            ...
            internalTransferContract = new ethers.Contract(
                ...
                internalTransferABI,
                wallet?.provider.getUncheckedSigner()
            )
    ...
    const sendTransaction = async () => {
        ...
        const estimateGas = () => {
            return wallet?.provider.estimateGas(txDetails).then(res => res.toString())
        }
    ...
    const renderDeviceSettings = () => {
        if (window.innerWidth < 700) {
            return (
                <div className={'conditional-ui-settings'}>
                    ...
                    <button
                        className={`bn-demo-button ${mobilePosition === 'top'
                            ? 'selected-toggle-btn'
                    ...
                    <button
                        className={`bn-demo-button ${mobilePosition === 'bottom'
                            ? 'selected-toggle-btn'
                            : 'unselected-toggle-btn'
                            }`}
                        onClick={() => {
        ...
        return (
            <div className={'conditional-ui-settings'}>
                ...
                <button
                    className={`bn-demo-button ${desktopPosition === 'topLeft'
                        ? 'selected-toggle-btn'
                        : 'unselected-toggle-btn'
                        }`}
                    onClick={() => {
                ...
                <button
                    className={`bn-demo-button ${desktopPosition === 'topRight'
                        ? 'selected-toggle-btn'
                        : 'unselected-toggle-btn'
                        }`}
                    onClick={() => {
                ...
                <button
                    className={`bn-demo-button ${desktopPosition === 'bottomRight'
                        ? 'selected-toggle-btn'
                        : 'unselected-toggle-btn'
                        }`}
                    onClick={() => {
                ...
                <button
                    className={`bn-demo-button ${desktopPosition === 'bottomLeft'
                        ? 'selected-toggle-btn'
                        : 'unselected-toggle-btn'
                        }`}
                    onClick={() => {
        ...
        <section className="main">
            <div className="main-content">
                ...
                <div className="container ui-settings">
                    ...
                    <button
                        className={`bn-demo-button ${darkMode ? 'selected-toggle-btn' : 'unselected-toggle-btn'
                            }`}
                        onClick={() => {
                            setDarkMode(true)
